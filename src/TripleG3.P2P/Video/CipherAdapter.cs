...
internal sealed class CipherAdapter : Video.Security.IVideoPayloadCipher
{
    private readonly IVideoPayloadCipher _inner;
    public CipherAdapter(IVideoPayloadCipher inner) => _inner = inner;
