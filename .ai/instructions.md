...
- 2026-08-27: Inbound peer-transfer data applies bounded asynchronous backpressure to the TCP read loop; temporary consumer scheduling delays must not fail an otherwise valid transfer.
